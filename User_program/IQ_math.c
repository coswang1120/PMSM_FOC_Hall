...
// 正余弦数据表  0--90度的0---32768    sin(90/256度)*2^15=0x00C9     sin(90/256度*2)*2^15=0x0192
...
void  IQSin_Cos_Cale(p_IQSin_Cos  pV)  
{
  ...
  hindex >>=6;      //65536/64  ===1024(360度)/4=90度=256  [2^16 ->  >>6   ->  2^10=1024 -> 1024/4=256 ]      0x01-0X'0'FF  ||  0X100 -0X'1'FF   ||   0X200-0X'2'FF   ||   0X300-0X'3'FF
...
int32_t  IQsat( int32_t Uint,int32_t  U_max, int32_t U_min) //限制赋值函数  // for all decimal calculate
{
	 int32_t Uout; 
 	if(Uint<= U_min)
		Uout= U_min;
